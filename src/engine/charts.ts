...
export const POSITION_HINT: Record<Position, string> = {
  utg: 'Ходите первым, а после вас — пятеро. Диапазон самый узкий.',
  hj: 'Позади четверо. Чуть шире ранней.',
  co: 'Позади трое. Открываемся заметно шире.',
  btn: 'После флопа ходите последним всю раздачу. Самая широкая позиция.',
  sb: 'Деньги уже вложены, но после флопа вы первый. Играем агрессивно или пасуем.',
  bb: 'Доплачиваете меньше всех, поэтому защищаетесь широко — но играете без позиции.',
}
